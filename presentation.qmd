...
#Ref https://search.r-project.org/CRAN/refmans/tidytable/html/separate_rows.html for separate_rows() 
...
pokemon_regions |>
  ...
  #Ref https://ggplot2.tidyverse.org/reference/position_jitter.html to help with overlap
  ...
  #Ref https://bulbapedia.bulbagarden.net/wiki/Help:Color_templates for color codes
