...
# Load packages here
pacman::p_load(tidymodels, tidyverse, readxl)
...
pokemon <- pokemon |>
  ...
  select(-c("height", "weight", "species_id", "base_experience", "color_1", "color_2", "color_f", "egg_group_1", "egg_group_2", "url_icon", "generation_id", "url_image"))
